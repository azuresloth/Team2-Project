		...
		<div class="col-10 ">
			<div class="row mt-2 justify-content-center">
				...
				<div class="col-12 text-center justify-content-center orderCompleteDiv">
					...
					<div class="little mt-2">주문내역에 관한 안내는 <a href="/cart/goOrderLookupPage">주문조회</a>를 통하여 확인 가능합니다.</div>
					<div class="little mt-4">주문코드 : <strong class="little">${orderCode}</strong></div>
					<div class="little">주문일자 : <strong class="little">${boughtList[0].buyDate}</strong></div>
				</div>
				...
				<div class="col-12 pageInfoTable2Div">
					<table class="pageInfoTable2">
						...
						<tr>
							<th>최종결제금액</th>
							<td><fmt:formatNumber type="number" value="${allTotalPrice}"></fmt:formatNumber>원</td>
						</tr>
						<tr>
							<th>결제수단</th>
							<td>
				...
				<div class="col-12 purInfoTableDiv">
					<table class="pageInfoTable text-center">
						...
						<c:forEach items="${boughtList}" var="boughtInfo">
							<tr>
								<td>
									<img alt="" src="/resources/images/item/itemImages/${boughtInfo.attachedImgName}" width="75px;">
								</td>
								<td>${boughtInfo.itemName}</td>
								<td><fmt:formatNumber type="number" value="${boughtInfo.totalPrice / boughtInfo.buyCnt}"></fmt:formatNumber>원</td>
								<td>
									${boughtInfo.buyCnt}개
								</td>
								<td>[무료]</td>
								<td>
									<fmt:formatNumber type="number" value="${boughtInfo.totalPrice}"></fmt:formatNumber>원
								</td>
							</tr>
						</c:forEach>
					</table>
				...
				<div class="col-12 buyTableDiv">
					<table class="buyTable text-center">
						...
						<tr>
							<td>
								<span>
									<fmt:formatNumber type="number" value="${allTotalPrice}"></fmt:formatNumber>원
									<input type="hidden" name="allTotalPrice" id="allTotalPrice" value="${allTotalPrice}">
				...
				<div class="col-12 pageInfoTable2Div">
					<table class="pageInfoTable2">
						...
						<tr>
							<th>받으시는 분</th>
							<td>
								${boughtList[0].deliveryName}
							</td>
						</tr>
						<tr>
							<th>우편번호</th>
							<td>
								${boughtList[0].postCode}
							</td>
						</tr>
						<tr>
							<th>주소</th>
							<td>
								${boughtList[0].roadAddr} ${boughtList[0].detailAddr}
							</td>
						</tr>
						<tr>
							<th>휴대전화</th>
							<td>
								${boughtList[0].deliveryTell}
							</td>
						</tr>
						<tr>
							<th>이메일</th>
							<td>
								${boughtList[0].deliveryEmail}
							</td>
						</tr>
						<tr>
							<th>배송메세지</th>
							<td>
								${boughtList[0].deliveryMsg}
							</td>
						</tr>
					</table>
