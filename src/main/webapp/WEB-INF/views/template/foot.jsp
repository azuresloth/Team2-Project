	...
	<div class="row footerRowDiv mt-5">
		<div class="row justify-content-center">
			...
			<div class="col-4 text-start pjEx pjEx-1">
				...
				<span>프로젝트</span>
				<br>
				<span>프로젝트명 : Team2 Shop Project</span>
				<br>
				<span>조원 : 이준호, 문영빈, 송병준, 정호연</span>
				<br>
				<span>git : https://github.com/azuresloth/Team2-Project.git</span>
			</div>
			<div class="col-2 pjEx">
				<br>
				<span>문의</span>
				<br>
				<span>call : 010-5343-3021</span>
				<br>
				<span>Email : qudwns4004@naver.com</span>
			</div>
